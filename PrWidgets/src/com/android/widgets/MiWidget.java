...
public class MiWidget extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		if (intent.getAction().equals("com.android.widgets.ACTUALIZAR_WIDGET")) {
	...
	{
		// Accedemos a las preferencias de la aplicacion
			...
			AppWidgetManager appWidgetManager, int widgetId)
	{
		...
		Intent intent = new Intent("com.android.widgets.ACTUALIZAR_WIDGET");
		intent.putExtra(
